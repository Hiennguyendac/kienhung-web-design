...
export const trainingDomains: TrainingDomain[] = [
  {
    ...
    programs: [
      ...
      {
        id: "ai-training-consultant-ai-transformation-executive",
        name: "AI Training - Consultant",
        tagline: "AI Transformation / Executive",
        level: "Doanh nghiệp - Executive",
        duration: "10 buổi làm việc chuyên sâu",
        format: "Executive workshop + strategic working session + stakeholder interviews",
        outcome:
          "Đồng hành Ban Lãnh đạo xây dựng tầm nhìn AI, thiết kế lộ trình 6-12 tháng và mô hình triển khai gắn KPI tăng trưởng, vận hành và ra quyết định.",
        image: "/education/program-ai.svg",
        audience:
          "Ban Lãnh đạo doanh nghiệp (CEO, COO, CTO, CFO, CHRO, Head of Strategy), quản lý cấp cao/trưởng phòng trọng yếu (Operations, Finance, Sales, Marketing, HR, Data, IT), doanh nghiệp vừa và lớn đã hoặc đang đầu tư AI nghiêm túc và cần chiến lược triển khai rõ ràng.",
        objectives: [
          "Hỗ trợ Ban Lãnh đạo xây dựng tầm nhìn và chiến lược AI dài hạn cho doanh nghiệp.",
          "Đánh giá mức độ sẵn sàng AI (AI maturity) về con người, quy trình, dữ liệu và công nghệ.",
          "Xác định use-case AI có tác động kinh doanh cao, khả thi trong ngắn và trung hạn.",
          "Định hình lộ trình chuyển đổi AI 6-12 tháng gắn mục tiêu tăng trưởng và tối ưu vận hành.",
          "Chuẩn bị nền tảng để doanh nghiệp triển khai AI bền vững, không phụ thuộc cá nhân.",
          "Tối ưu chi phí, tăng năng suất và nâng cao chất lượng ra quyết định.",
        ],
        coreContent: [
          "Đánh giá hiện trạng doanh nghiệp (AI maturity assessment).",
          "Phân tích quy trình vận hành và các quyết định của các phòng ban trọng yếu.",
          "Xác định và ưu tiên AI use-cases theo tác động kinh doanh (ROI-driven).",
          "Thiết kế AI roadmap 6-12 tháng theo khung people - process - technology.",
          "Workshop chiến lược cho C-level/manager cấp cao.",
          "Đề xuất mô hình tổ chức và năng lực AI nội bộ (AI team / AI champion).",
          "Xây dựng khung governance và nguyên tắc sử dụng AI trong doanh nghiệp.",
          "Định hướng các pilot/proof-of-concept cho giai đoạn tiếp theo.",
        ],
        deploymentFormat: [
          "10 buổi đào tạo làm việc chuyên sâu.",
          "Kết hợp executive workshop, strategic working session và phỏng vấn key stakeholders.",
          "Làm việc trực tiếp với Ban Lãnh đạo, trưởng phòng và key managers.",
          "Sử dụng dữ liệu và quy trình thật theo mức độ cho phép của doanh nghiệp.",
          "Bàn giao tài liệu chiến lược và roadmap sau chương trình.",
          "Có phiên tổng kết và đề xuất triển khai giai đoạn tiếp theo.",
        ],
        roadmapPhases: [
          "Discovery & Alignment",
          "Strategy & Roadmap Design",
        ...
        baseFeeIncludes: [
          "AI maturity assessment (con người - quy trình - dữ liệu - công nghệ).",
          "Executive workshop cho Ban Lãnh đạo.",
          "Phân tích quy trình và use-case trọng yếu.",
          "Xây dựng AI Vision & Strategy.",
          "Thiết kế AI Roadmap 6-12 tháng.",
          "Tài liệu chiến lược và báo cáo tổng hợp bàn giao.",
        ],
        pricingTiers: [
          { scale: "Quy mô > 50 nhân sự", price: "Phụ phí 15% - 80%", note: "Điều chỉnh theo độ phức tạp" },
          { scale: "> 3 phòng ban", price: "Phụ phí 15% - 80%", note: "Mở rộng phạm vi phối hợp liên phòng ban" },
          { scale: "Dữ liệu phân tán/chưa chuẩn hóa", price: "Phụ phí 20% - 100%", note: "Tăng effort chuẩn hóa dữ liệu" },
          { scale: "Can thiệp sâu quy trình", price: "Phụ phí 45% - 300%", note: "Thiết kế lại vận hành và governance" },
          { scale: "Thời gian > 8-10 tuần", price: "Phụ phí 25% - theo hợp đồng", note: "Tùy tiến độ và phạm vi triển khai" },
        ],
        pricingFootnote: "Mở rộng quy mô vượt mức tham chiếu sẽ được đánh giá và báo giá lại theo phạm vi triển khai.",
      },
    ],
