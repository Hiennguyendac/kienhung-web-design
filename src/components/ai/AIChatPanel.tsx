...
const STORAGE_KEY = "kh-ai-chat-history";
...
export const AIChatPanel = ({ open, onClose }: AIChatPanelProps) => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content: "Xin chào! Tôi có thể hỗ trợ thông tin dịch vụ, dự án và tư vấn nhanh. Bạn cần gì hôm nay?",
    },
  ]);
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 w-full max-w-md rounded-2xl border border-border bg-background shadow-elevated overflow-hidden">
      ...
      <div ref={listRef} className="max-h-[48vh] overflow-y-auto px-4 py-3 bg-secondary/20 space-y-3">
